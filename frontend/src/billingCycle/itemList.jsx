    ...
    renderRows() {
        ...
        return list.map((item, index) => (
            <tr key={index}>
                ...
                <td>
                    <Field name={`${this.props.field}[${index}].value`} component={Input} placeholder='Informe o valor' readOnly={this.props.readOnly} /></td>
                    ...
                    <table>
                        <thead> 
                            <tr>
                                ...
                                <th className='table-actions'>Ações</th>
                            </tr>
                        </thead>
                        <tbody> 
                            {this.renderRows()}
