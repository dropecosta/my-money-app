...
class CreditList extends Component {
    ...
    add(index, item = {}) { if(!this.props.readOnly) {
    ...
    renderRows() {
        ...
        return list.map((item, index) => (
            <tr key={index}>
                ...
                <td>
                    <Field name={`credits[${index}].value`} component={Input} placeholder='Informe o valor' readOnly={this.props.readOnly} /></td>
                <td>
